...
async function translateText(
  ...
  try {
    const systemPrompt = "You are a helpful assistant engaging in a conversation.";
    const userPrompt = `Respond to the following input in ${outputLanguage} as if you were having a conversation. Keep your responses concise and brief. Output response directly without any additional text.\nInput: ${text}\nResponse:`;
