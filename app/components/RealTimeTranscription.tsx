...
import { Button, Typography, Container, Paper, Box, Grid, CssBaseline } from '@mui/material';
    ...
    const handleFileUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file && socketRef.current) {
            ...
            reader.onloadend = () => {
                const base64data = reader.result as string;
                if (base64data) {
                    socketRef.current!.send(JSON.stringify({ type: 'upload', audio: base64data.split(',')[1] }));
